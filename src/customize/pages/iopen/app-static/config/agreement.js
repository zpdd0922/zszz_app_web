(function (window) {
    ...
    Global_Config_Agreements.zh_HK = {
        list: [
            { content: '證券協議的一般條款', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=general_terms&lang=zh_HK" },
            { content: '保證金帳戶風險披露', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=disclosure_margin&lang=zh_HK" },
            { content: '衍生產品交易風險披露', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=disclosure_derivative&lang=zh_HK" },
            { content: '關於證券交易的風險披露聲明及免責條款', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=sec_trade&lang=zh_HK" },
            { content: '關於中華通之下的北向證券交易服務之附加條款', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=north_terms&lang=zh_HK" },
            { content: '客戶款項常設授權', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=standing_auth&lang=zh_HK" },
            { content: '隱私保護政策', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=privacy_policy&lang=zh_HK" },
