(function (window) {
    ...
    Global_Config_Agreements.zh_CN = {
        ...
        addLimit: { content: '风险披露', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=disclosure_margin&lang=zh_CN" },
    };
    Global_Config_Agreements.zh_HK = {
        ...
        addLimit:{ content: '風險披露', href: window._GLOBAL_ENV_CONFIG.webAgreement + "?key=disclosure_margin&lang=zh_CN" },
    };
