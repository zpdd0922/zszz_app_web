var hljs = new function () {
  var q = {}; var a = {}; function o(c) { return c.replace(/&/gm, '&amp;').replace(/</gm, '&lt;').replace(/>/gm, '&gt;'); } function l(t, s) { if (!t) { return false; } for (var c = 0; c < t.length; c++) { if (t[c] == s) { return true; } } return false; } function e(t, s, c) { var u = 'm' + (t.cI ? 'i' : '') + (c ? 'g' : ''); return new RegExp(s, u); } function k(s) { for (var c = 0; c < s.childNodes.length; c++) { node = s.childNodes[c]; if (node.nodeName == 'CODE') { return node; } if (!(node.nodeType == 3 && node.nodeValue.match(/\s+/))) { return null; } } } function i(t) { var s = ''; for (var c = 0; c < t.childNodes.length; c++) { if (t.childNodes[c].nodeType == 3) { s += t.childNodes[c].nodeValue; } else { if (t.childNodes[c].nodeName == 'BR') { s += '\n'; } else { s += i(t.childNodes[c]); } } } return s; } function b(u) { var s = u.className.split(/\s+/); s = s.concat(u.parentNode.className.split(/\s+/)); for (var c = 0; c < s.length; c++) { var t = s[c].replace(/^language-/, ''); if (t == 'no-highlight') { throw 'No highlight'; } if (q[t]) { return t; } } } function d(c) { var s = []; (function (u, v) { for (var t = 0; t < u.childNodes.length; t++) { if (u.childNodes[t].nodeType == 3) { v += u.childNodes[t].nodeValue.length; } else { if (u.childNodes[t].nodeName == 'BR') { v += 1; } else { s.push({ event: 'start', offset: v, node: u.childNodes[t] }); v = arguments.callee(u.childNodes[t], v); s.push({ event: 'stop', offset: v, node: u.childNodes[t] }); } } } return v; })(c, 0); return s; } function n(A, B, z) { var t = 0; var y = ''; var v = []; function w() { if (A.length && B.length) { if (A[0].offset != B[0].offset) { return (A[0].offset < B[0].offset) ? A : B; } else { return (A[0].event == 'start' && B[0].event == 'stop') ? B : A; } } else { return A.length ? A : B; } } function u(F) { var G = '<' + F.nodeName.toLowerCase(); for (var D = 0; D < F.attributes.length; D++) { var E = F.attributes[D]; G += ' ' + E.nodeName.toLowerCase(); if (E.nodeValue != undefined) { G += '="' + o(E.nodeValue) + '"'; } } return G + '>'; } function C(D) { return '</' + D.nodeName.toLowerCase() + '>'; } while (A.length || B.length) { var x = w().splice(0, 1)[0]; y += o(z.substr(t, x.offset - t)); t = x.offset; if (x.event == 'start') { y += u(x.node); v.push(x.node); } else { if (x.event == 'stop') { var s = v.length; do { s--; var c = v[s]; y += C(c); } while (c != x.node);v.splice(s, 1); while (s < v.length) { y += u(v[s]); s++; } } } }y += z.substr(t); return y; } function h(K, E) {
    function L(Q, P) { Q.sm = []; for (var O = 0; O < Q.c.length; O++) { for (var N = 0; N < P.m.length; N++) { if (P.m[N].cN == Q.c[O]) { Q.sm[Q.sm.length] = P.m[N]; } } } } function A(N, P) { if (!P.c) { return null; } if (!P.sm) { L(P, I); } for (var O = 0; O < P.sm.length; O++) { if (P.sm[O].bR.test(N)) { return P.sm[O]; } } return null; } function x(O, N) { if (D[O].e && D[O].eR.test(N)) { return 1; } if (D[O].eW) { var P = x(O - 1, N); return P ? P + 1 : 0; } return 0; } function y(N, O) { return O.iR && O.iR.test(N); } function B(T, R) { var P = []; function S(U) { if (!l(P, U)) { P[P.length] = U; } } if (T.c) { for (var O = 0; O < R.m.length; O++) { if (l(T.c, R.m[O].cN)) { S(R.m[O].b); } } } var N = D.length - 1; do { if (D[N].e) { S(D[N].e); }N--; } while (D[N + 1].eW);if (T.i) { S(T.i); } var Q = '(' + P[0]; for (var O = 0; O < P.length; O++) { Q += '|' + P[O]; }Q += ')'; return e(R, Q); } function t(P, O) {
      var Q = D[D.length - 1]; if (!Q.t) { Q.t = B(Q, I); }P = P.substr(O); var N = Q.t.exec(P); if (!N) {
        return [
          P, '', true
        ];
      } if (N.index == 0) {
...
m: [
  { cN: 'at_rule',
    ...
    c: [
      'function', 'string', 'number', 'pseudo'
    ] }, { cN: 'id', b: '\\#[A-Za-z0-9_-]+', e: '^' }, { cN: 'class', b: '\\.[A-Za-z0-9_-]+', e: '^', r: 0 }, { cN: 'attr_selector', b: '\\[', e: '\\]', i: '$' }, { cN: 'pseudo', b: ":(:)?[a-zA-Z0-9\\_\\-\\+\\(\\)\\\"\\']+", e: '^' }, { cN: 'rules',
    b: '{',
    e: '}',
    c: [
      'rule', 'comment'
    ],
    i: '[^\\s]' }, { cN: 'rule', b: '[A-Z\\_\\.\\-]+\\s*:', e: ';', eW: true, l: ['[A-Za-z-]+'], k: { 'play-during': 1, 'counter-reset': 1, 'counter-increment': 1, 'min-height': 1, quotes: 1, 'border-top': 1, pitch: 1, font: 1, pause: 1, 'list-style-image': 1, 'border-width': 1, cue: 1, 'outline-width': 1, 'border-left': 1, elevation: 1, richness: 1, 'speech-rate': 1, 'border-bottom': 1, 'border-spacing': 1, background: 1, 'list-style-type': 1, 'text-align': 1, 'page-break-inside': 1, orphans: 1, 'page-break-before': 1, 'text-transform': 1, 'line-height': 1, 'padding-left': 1, 'font-size': 1, right: 1, 'word-spacing': 1, 'padding-top': 1, 'outline-style': 1, bottom: 1, content: 1, 'border-right-style': 1, 'padding-right': 1, 'border-left-style': 1, 'voice-family': 1, 'background-color': 1, 'border-bottom-color': 1, 'outline-color': 1, 'unicode-bidi': 1, 'max-width': 1, 'font-family': 1, 'caption-side': 1, 'border-right-width': 1, 'pause-before': 1, 'border-top-style': 1, color: 1, 'border-collapse': 1, 'border-bottom-width': 1, 'float': 1, height: 1, 'max-height': 1, 'margin-right': 1, 'border-top-width': 1, speak: 1, 'speak-header': 1, top: 1, 'cue-before': 1, 'min-width': 1, width: 1, 'font-variant': 1, 'border-top-color': 1, 'background-position': 1, 'empty-cells': 1, direction: 1, 'border-right': 1, visibility: 1, padding: 1, 'border-style': 1, 'background-attachment': 1, overflow: 1, 'border-bottom-style': 1, cursor: 1, margin: 1, display: 1, 'border-left-width': 1, 'letter-spacing': 1, 'vertical-align': 1, clip: 1, 'border-color': 1, 'list-style': 1, 'padding-bottom': 1, 'pause-after': 1, 'speak-numeral': 1, 'margin-left': 1, widows: 1, border: 1, 'font-style': 1, 'border-left-color': 1, 'pitch-range': 1, 'background-repeat': 1, 'table-layout': 1, 'margin-bottom': 1, 'speak-punctuation': 1, 'font-weight': 1, 'border-right-color': 1, 'page-break-after': 1, position: 1, 'white-space': 1, 'text-indent': 1, 'background-image': 1, volume: 1, stress: 1, outline: 1, clear: 1, 'z-index': 1, 'text-decoration': 1, 'margin-top': 1, azimuth: 1, 'cue-after': 1, left: 1, 'list-style-position': 1 }, c: ['value'] }, hljs.CBLCLM, { cN: 'value',
    b: '^',
    eW: true,
    eE: true,
    c: [
      'function', 'number', 'hexcolor', 'string'
    ] }, { cN: 'number', b: hljs.NR, e: '^' }, { cN: 'hexcolor', b: '\\#[0-9A-F]+', e: '^' }, { cN: 'function', b: hljs.IR + '\\(', e: '\\)', c: ['params'] }, { cN: 'params',
    b: '^',
    eW: true,
    eE: true,
    c: [
