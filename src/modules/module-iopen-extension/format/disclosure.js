...
export const disclosureDefine = {
  ...
  // isNotOurStaffKin: { disclosureCode: '25', disclosureSize: 1, isCanFalse: true, valueKey: 'isNotOurStaffKin', disclosure1Key: 'ourStaffKinName', disclosure2Key: 'ourStaffKinRelation', disclosure3Key: '', disclosure4Key: '' },
  // isNotHkexParterStaff: { disclosureCode: '26', disclosureSize: 1, isCanFalse: true, valueKey: 'isNotHkexParterStaff', disclosure1Key: 'hkexParterName', disclosure2Key: 'hkexParterCENo', disclosure3Key: '', disclosure4Key: '' },
  isNotConsortWithMargin: { disclosureCode: '27', disclosureSize: 1, isCanFalse: false, valueKey: 'isNotConsortWithMargin', disclosure1Key: 'withMarginName', disclosure2Key: 'withMarginAccount', disclosure3Key: '', disclosure4Key: '' },
  isNotConsortWithOtherMargin: { disclosureCode: '28', disclosureSize: 1, isCanFalse: false, valueKey: 'isNotConsortWithOtherMargin', disclosure1Key: 'withOtherMarginName', disclosure2Key: 'withOtherMarginAccount', disclosure3Key: '', disclosure4Key: '' },
  ...
  isNotBOorPG: { disclosureCode: '29', disclosureSize: 1, isCanFalse: false, valueKey: 'isNotBOorPG', disclosure1Key: 'otherPOorBGMarginName', disclosure2Key: 'otherPOorBGMarginAccount', disclosure3Key: '', disclosure4Key: '' },
  adjectiveAuth: { disclosureCode: '30', disclosureSize: 1, isCanFalse: false, valueKey: 'adjectiveAuth', disclosure1Key: 'adjectiveAuth', disclosure2Key: 'adjectiveAuth', disclosure3Key: '', disclosure4Key: '' },
};
