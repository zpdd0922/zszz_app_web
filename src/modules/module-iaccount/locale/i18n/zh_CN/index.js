  ...
  iAccount: {
    ...
    deposit: {
      ...
      common: {
        ...
        text_5: '通知收款时需要上传转账记录截图作为凭证，同时截取的凭证中一定要有“备案号”，否则可能导致汇款不成功。',
        text_6: '提交',
        text_7: '银行费用：',
        text_8: '到账时间：',
        text_9: '可用时间：',
      ...
      bank_list: {
        title: '请选择汇出银行',
        text_1: '近期不少客户反映通过内地银行存入资金被退回几率增高，立桥提醒客户留意相关风险， 入金被退回可能会产生手续费及汇兑损失，如发生资金退回情况，请及时联络银行处理。 立桥证券恕不负责任何银行向客户所收取任何形式的手续费或额外收费及任何汇兑损失。 立桥证券建议您通过香港本地银行卡存入资金。 建议单笔入金额不要超过10万港币（或等值美元）。立桥证券现已开通香港本地主流银行的快速办理通道，如汇丰银行、民生银行、中国银行香港等，欢迎选用。',
        cmbchk: '民生银行（香港）',
        cmbwlb: '招商永隆银行'
      ...
      cmbchk: {
        ...
        text_3: '0元',
        text_4: '什么是银证转账',
        text_5: '银证转账是指银行根据用户指令，为其提供证券交易时间内个人银行账户与立桥证券资金账户之间的资金实时划转的金融服务。您可通过银证转账直接将银行资金转入立桥证券账户。',
        text_6: '如何进行银证转账',
      ...
      edda: {
        ...
        bind: {
          ...
          <p>通过在智珠宝移动应用程式上勾选“本人已阅读、理解并同意接受《快捷入金用户协议》“即表示您已签署本条款及细则，并同意受本条款及细则的所有条款的约束。</p>
          ...
          <p>2. 电子直接付款授权服务</p>
          <p>(a) 基于立桥证券与银行的授权与合作，立桥证券将向客户申请电子直接付款授权服务提供相应服务，即客户若通过立桥证券向银行申请电子直接付款授权服务的，立桥证券将协助前述申请指令、资料及资讯按照银行要求路径传送至银行，授权被银行批核后，客户可直接向立桥证券发出指示，进行由银行至立桥证券的直接付款授权资金转账。若该授权申请被银行拒绝，立桥证券会通知客户该授权结果，但并不会就该授权结果负任何责任。</p>
          ...
          <p>(i) 阁下须于发出网上存款之有关指示前，自行确保所有有关的程序、步骤、数据、帐户号码、缴付账单号码、个人悉别号码、存入之金额及有关存入金钱或资金至立桥证券之资料已被详细检查及核实为真实、正确及无误。当阁下以任何方式发出网上存款之有关指示后，该等指示均不可在并无立桥证券的书面同意下被修订、撤销、删除或取消，并对立桥证券具有效性及效力及对阁下构成绝对及不可推翻的约束力。阁下确认立桥证券不会于任何情况下因网上存款而产生或与之有关之损失、讼费、费用、开支而承担任何责任，即使客户于发出该等指示时有错误或误会；</p>
          ...
          <p>5. 收集及使用阁下资料</p>
          <p>(a) 为了使用电子直接付款授权服务，阁下可能需要不时向立桥证券提供个人资料及其他资料，立桥证券不时就有关证券服务及电子直接付款授权服务获提供或由立桥证券编制的个人资料及资讯统称为「客户资料」。</p>
          ...
          <p>阁下确认及同意，由于您自身原因，包括任何不明确或不完整的说明而导致服务无法执行和/或由于阁下自身的任何错误和/或系统故障导致的任何直接损失、损害或费用、间接损失或由此造成的损失，损害或费用概不负责, 並須就因此而直接或間接招致或與此相關的所有費用、索償、債務及開支，全數向立橋證券作出彌償。</p>
          <p>8. 分割性</p>
          ...
          `
            // text_10: '本部份规管立桥证券为客户提供电子直接付款授权服务及客户使用电子直接付款授权服务。本部份补充各项立桥证券不时修订之条款及细则及任何适用于规管立桥证券服务的协议或条款及细则。通过在智珠宝移动应用程式上勾选“本人已阅读、理解并同意接受《快捷入金用户协议》“即表示您已签署本条款及细则，并同意受本条款及细则的所有条款的约束。',
            ...
            // text_14: '(a) 基于立桥证券与银行的授权与合作，立桥证券将向客户申请电子直接付款授权服务提供相应服务，即客户若通过立桥证券向银行申请电子直接付款授权服务的，立桥证券将协助前述申请指令、资料及资讯按照银行要求路径传送至银行，授权被银行批核后，客户可直接向立桥证券发出指示，进行由银行至立桥证券的直接付款授权资金转账。若该授权申请被银行拒绝，立桥证券会通知客户该授权结果，但并不会就该授权结果负任何责',
            // text_15: '银行账号只能输入数字'
          }
        },
        remit: {
        ...
        tips: {
          text_1: '1.什么是快捷入金？',
          text_2: '快捷入金是指客户通过eDDA授权立桥证券从指定的香港银行账户划拨指定数额的资金至证券账户。eDDA即电子直接付款授权，是香港金管局推出的FPS转数快系统的增值服务。',
          text_3: '2.快捷入金有哪些优势',
      ...
      fps: {
        ...
        tips: {
          ...
          text_14: '(6)上传汇款凭证（可直接点击），或打开智珠宝App，点击【我的】-【证券服务】-【存入资金】，进行上传'
        }
      },
      eBanking: {
        ...
        text_12: '收款账号由立桥证券在星展银行以您的名义开立,用于接收来自大陆银行的同名,点击免费免费获取收款账号.请注意,账号需要至少60分钟才能生效,一经生效,可永久使用',
    ...
    withdraw: {
      ...
      select_bank: {
        text_1: '出金提示',
        text_2: '近期有较多客户反馈大陆银行无法接收外汇汇款。如发生退款，已收取的手续费银行不做退回，并且退款时间较长（5-20个工作日）。立桥正在准备新的出金渠道尽力为客户提供顺畅的服务体验。如您近期有提款需求，建议提前办理香港银行卡。',
        text_3: '办卡指引',
      ...
      request: {
        ...
        text_19: '可提金额：',
        text_20: '全部提取',
        text_21: '200-400港币（银行收取), 提取金额1000元以下时立桥证券将收取10港币手续费',
        text_22: '5-10个银行工作日',
        text_23: '5-10个银行工作日',
        text_24: '提取',
        text_25: '请选择您的提取账户',
    ...
    my_bank: {
      ...
      text_7: '解绑失败',
      text_8: '您还没有绑定银行卡',
      text_9: '1.【我的银行卡】中记录了您入金银行卡相关信息，立桥证券保证所有信息只会用于您在立桥证券的出入金等资金操作，不会用于其他任何行为；',
      text_10: '2.很抱歉当前不支持香港银行卡删除操作，如果有删除需求请您咨询客服',
      text_11: '立桥证券每个用户最多可使用三张香港银行卡入金，您需要解绑至少一张香港银行卡，才能选择其他银行卡入金',
      text_12: '立桥证券每个用户最多可使用三张大陆银行卡入金，您需要解绑至少一张大陆银行卡，才能选择其他银行卡入金',
    ...
    out_stock: {
      name: '转出股票',
      info_tips: '请您至立桥证券官网下载并填写转出股票表格，若有疑问，请咨询客服400-688-3187'
    },
    brokerage: {
      name: '我的佣金'
    },
