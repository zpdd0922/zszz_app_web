export const intoStock = {
  ...
  transferInfo: {
    ...
    warn: {
      otherTransferOutCompanyName: '请输入正确的券商名称',
      accountNumber: '请输入正确的账户号码',
      accountName: '请输入正确的账户名称',
      ccass: "请输入正确的CCASS号码",
      rolloutContacts: "请输入正确的联系人",
      contactsPhoneNum: "请输入正确的联系人电话",
    },
    tips:"账户姓名：需与立桥账户$clientNameCn$ ($clientNameEn$) 同名,不允许使用第三方账户转入股票",
    tips1: "账户姓名：需与立桥账户同名(",
