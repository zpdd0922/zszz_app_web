...
        text_5: '通知收款時需要上傳轉賬記錄截圖作為憑證，同時截取的憑證中一定要有“備案號”，否則可能導致匯款不成功。',
        text_6: '提交',
        text_7: '銀行費用：',
        text_8: '到賬時間：',
        text_9: '可用時間：',
...
      bank_list: {
        title: '請選擇匯出銀行',
        text_1: '近期不少客戶反映通過內地銀行存入資金被退回幾率增高，立橋提醒客戶留意相關風險， 入金被退回可能會產生手續費及匯兌損失，如發生資金退回情況，請及時聯絡銀行處理。 立橋證券恕不負責任何銀行向客戶所收取任何形式的手續費或額外收費及任何匯兌損失。 立橋證券建議您通過香港本地銀行卡存入資金。 建議單筆入金額不要超過10萬港幣（或等值美元）。立橋證券現已開通香港本地主流銀行的快速辦理通道，如匯豐銀行、民生銀行、中國銀行香港等，歡迎選用。',
        cmbchk: '民生銀行（香港）',
        cmbwlb: '招商永隆銀行'
...
        text_3: '0元',
        text_4: '什麼是銀證轉賬',
        text_5: '銀證轉賬是指銀行根據用戶指令，為其提供證券交易時間內個人銀行帳戶與立橋證券資金帳戶之間的資金即時劃轉的金融服務。您可通過銀證轉賬直接將銀行資金轉入立橋證券帳戶。',
        text_6: '如何進行銀證轉賬',
        text_7: '通過香港民生手機APP或香港民生電腦網銀：進入【銀證轉賬-轉出轉入-銀行轉至商戶】，填寫扣款帳戶及轉賬金額即可進行轉賬入金，限定交易時間為香港工作日的08:00-16:00。',
        text_8: '查看銀證轉賬指南',
        text_9: '1、民生網銀限定的交易時間為香港工作日的08: 00 - 16: 00（北京時間），限定當天首筆入金金額不超過200萬港幣，非工作時間以及週六、周日和香港假期不接受轉賬申請。',
...
        text_8: '查看銀證轉賬指南',
        text_9: '1、招商永隆銀行限定的交易時間為香港工作日的08:00-16:00（北京時間），非工作時間以及週六、周日和香港假期不接受轉賬申請。      ',
        text_10: '2、銀證轉賬操作則無需在犇犇進行發起匯款通知。',
        text_11: '您關聯銀行的證券帳戶：'
      },
      ways: {
...
            text_3: '2.銀行處理您的授權一般需要1~5個工作日，授權結果將會通過短信通知到您。',
            text_4: '1.什麼是港幣帳戶？',
...
          `
            // text_10: '本部份規管立橋證券為客戶提供電子直接付款授權服務及客戶使用電子直接付款授權服務。本部份補充各項立橋證券不時修訂之條款及細則及任何適用於規管立橋證券服務的協議或條款及細則。通過在智珠寶移動應用程式上勾選“本人已閱讀、理解並同意接受《快捷入金用戶協議》“即表示您已簽署本條款及細則，並同意受本條款及細則的所有條款的約束。',
            // text_11: '1. 在本條款及細則，下列的詞語具下列定義：',
            // text_12: `「電子直接付款授權」指使用結算公司快速支付系統以電子方式設置的直接付款授權。
            // 「電子直接付款授權服務」指由結算公司提供作為結算公司快速支付系統一部份的服務，讓參與者的客戶設置直接付款授權並具有第2(a)條中規定的含義。
            // 「閣下」及「閣下的」指立橋證券提供證券服務的每位客戶，及如文義允許，包括任何獲客戶授權向立橋證券發出有關使用證券服務的指示或要求的人士。
            // 「結算公司」指香港銀行同業結算有限公司及其繼承人及受讓人。
            // 「結算公司快速支付系統」或「快速支付系統」指由結算公司不時提供、管理及運作的快速支付系統及其相關設施及服務，用作(i)處理直接付款及存款、資金轉賬及其他付款交易；及(ii)就電子直接付款授權服務及帳戶綁定服務交換及處理指示。
            // 「香港」指中華人民共和國香港特別行政區。
            // 「監管規定」指本公司、銀行、結算公司、任何其他參與者、彼等各自的聯繫公司或集團公司或閣下不時受規限或被期望遵守的任何法律、規例或法庭判令，或由任何監管機構、政府機關(包括稅務機關)、結算或交收銀行、交易所、業界或自律監管團體(不論於香港境內或境外)發出的任何規則、指示、指引、守則、通知或限制(不論是否具有法律效力)。`,
            // text_13: '2. 電子直接付款授權服務：',
            // text_14: '(a) 基於立橋證券與銀行的授權與合作，立橋證券將向客戶申請電子直接付款授權服務提供相應服務，即客戶若通過立橋證券向銀行申請電子直接付款授權服務的，立橋證券將協助前述申請指令、資料及資訊按照銀行要求路徑傳送至銀行，授權被銀行批核後，客戶可直接向立橋證券發出指示，進行由銀行至立橋證券的直接付款授權資金轉賬。若該授權申請被銀行拒絕，立橋證券會通知客戶該授權結果，但並不會就該授權結果負任何責',
            // text_15: '銀行帳號只能輸入數字'
          }
        },
        remit: {
...
            text_3: '請選擇匯款帳號',
            text_4: '請輸入存入金額',
            text_5: '*請確保銀行帳戶有足夠資金，以免資金不足導致扣款失敗，影響您的交易。',
            text_6: '存入金額至少0.01港幣',
            text_7: '存入金額請勿超過單筆限額'
          }
        },
        notify: {
          text_1: '恭喜您，提交成功！',
          text_2: '銀行處理您的授權一般需要1~5個工作日，授權結果將會通過短信通知到您。',
          text_3: '港股交易時間段最快5分鐘入賬，非港股交易時間段將於下個港股交易日09:00前入賬，具體時間請以短信通知為准。',
          text_4: '查看入金狀態'
        },
        tips: {
          text_1: '1.什麼是快捷入金？',
...
          text_14: '(6)上傳匯款憑證（可直接點擊），或打開智珠寶App，點擊【我的】-【證券服務】-【存入資金】，進行上傳'
        }
      },
      eBanking: {
...
        text_12: '收款帳號由立橋證券在星展銀行以您的名義開立,用於接收來自大陸銀行的同名,點擊免費免費獲取收款帳號.請注意,帳號需要至少60分鐘才能生效,一經生效,可永久使用',
...
      },
      check: {
        text_1: '請使用您本人 {config} 的銀行帳戶匯款，匯款人請填寫證券預留姓名 {config}',
        text_2: '1、支票填寫：',
        text_3: '收款人名稱',
        text_4: '收款人帳號',
        text_5: '2、發起匯款通知：',
...
        text_6: '在此輸入金額',
        text_7: '上傳憑證',
        text_8: '根據香港證監會要求，入金必須為同名帳戶，為保證您的資金安全和入賬速度，請確保您上傳的憑證包含匯款銀行名稱、姓名、完整匯款帳號和收款帳號等資訊，如果一張圖片不能同時包含匯款銀行名稱和姓名，可補充上傳銀行結單或截圖輔助證明。',
        text_9: '備註',
        text_10: '請輸入備註（選填）',
...
      select_bank: {
        text_1: '出金提示',
        text_2: '近期有較多客戶回饋大陸銀行無法接收外匯匯款。如發生退款，已收取的手續費銀行不做退回，並且退款時間較長（5-20個工作日）。立橋正在準備新的出金管道盡力為客戶提供順暢的服務體驗。如您近期有提款需求，建議提前辦理香港銀行卡。',
        text_3: '辦卡指引',
...
        text_12: '請向您的{name}收款銀行諮詢Swift Code，提供錯誤資訊可能會發生提款延遲及額外費用。',
        text_13: '聯繫地址',
        text_14: '請輸入聯繫地址（非必填）',
        text_15: '資金資訊',
        text_16: '幣種',
...
        text_30: '您尚未入金或未綁定香港銀行卡，請先入金或綁卡，如有疑問請聯繫客服，點擊撥打',
        text_31: '銀行名稱',
        text_32: '在此輸入銀行名稱',
        text_33: '手續費',
        text_34: '實際提取金額',
...
      text_7: '解綁失敗',
      text_8: '您還沒有綁定銀行卡',
      text_9: '1.【我的銀行卡】中記錄了您入金銀行卡相關資訊，立橋證券保證所有資訊只會用於您在立橋證券的出入金等資金操作，不會用於其他任何行為；',
      text_10: '2.很抱歉當前不支持香港銀行卡刪除操作，如果有刪除需求請您諮詢客服',
      text_11: '立橋證券每個用戶最多可使用三張香港銀行卡入金，您需要解綁至少一張香港銀行卡，才能選擇其他銀行卡入金',
      text_12: '立橋證券每個用戶最多可使用三張大陸銀行卡入金，您需要解綁至少一張大陸銀行卡，才能選擇其他銀行卡入金',
...
        text_2: '出金記錄',
        text_3: '存入總額',
        text_4: '到賬金額為您歷史成功入金金額之和，如果您對統計結果存在疑問，請您諮詢客服',
        text_5: '提取總額',
        text_6: '到賬金額為您歷史成功提取金額之和，針對統計結果如果有疑問，請您諮詢客服',
