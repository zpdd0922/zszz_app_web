...
export default {
  ...
  deposit: {
    ...
    common: {
      ...
      text_5: '通知立桥收款時需要上傳轉賬記錄截圖作為憑證，同時截取的憑證中一定要有“備案號”，否則可能導致匯款不成功。',
      text_6: '提交',
      text_7: '銀行費用：',
      text_8: '到賬時間：',
      text_9: '可用時間：',
    ...
    bank_list: {
      title: '請選擇匯出銀行',
      text_1: '近期不少客戶反映通過內地銀行存入資金被退回幾率增高，立桥提醒客戶留意相關風險， 入金被退回可能會產生手續費及匯兌損失，如發生資金退回情況，請及時聯絡銀行處理。立橋證券恕不負責任何銀行向客戶所收取任何形式的手續費或額外收費及任何匯兌損失。 立橋證券建議您通過香港本地銀行卡存入資金。 建議單筆入金額不要超過10萬港幣（或等值美元）。立橋證券現已開通香港本地主流銀行的快速辦理通道，如匯豐銀行、民生銀行、中國銀行香港等，歡迎選用。',
      cmbchk: '民生銀行（香港）',
      cmbwlb: '招商永隆銀行'
    },
    cmbchk: {
      ...
      text_3: '0元',
      text_4: '什麽是銀證轉賬',
      text_5: '銀證轉賬是指銀行根據用戶指令，為其提供證券交易時間內個人銀行賬戶與立橋證券資金賬戶之間的資金實時劃轉的金融服務。您可通過銀證轉賬直接將銀行資金轉入立橋證券賬戶。',
      text_6: '如何進行銀證轉賬',
    ...
    edda: {
      ...
      bind: {
        ...
        tips: {
          ...
          <p>通過在智珠宝移動應用程式上勾選“本人已閱讀、理解並同意接受《快捷入金用戶協議》“即表示您已簽署本條款及細則，並同意受本條款及細則的所有條款的約束。</p>
          ...
          <p>7. 免責及責任承擔</p>
          <p>閣下確認及同意，任何因您違反您的陳述或擔保、或您接受並執行任何說明、或應依照相關條款和約定應履行的相關義務，或其他您任何與前述違約行為有關的情形由此給我們及立桥集團項下任何其他成員造成任何損失，損害，責任，成本，索償，要求和其他支出（無論是否基於稅收，關稅或其他事項），您均應承擔全部賠償責任。</p>
          ...
          `
          // text_10: ' 本部份規管立橋證券為客戶提供電子直接付款授權服務及客戶使用電子直接付款授權服務。本部份補充各項立橋證券不時修訂之條款及細則及任何適用於規管立橋證券服務的協議或條款及細則。通過在智珠宝移動應用程式上勾選「本人已閱讀、理解並同意接受《快捷入金用戶協議》「即表示您已簽署本條款及細則，並同意受本條款及細則的所有條款的約束。',
          // text_11: '1. 在本條款及細則，下列的詞語具下列定義：',
          // text_12: `「電子直接付款授權」指使用結算公司快速支付系統以電子方式設置的直接付款授權。 「電子直接付款授權服務」指由結算公司提供作為結算公司快速支付系統一部份的服務，讓參與者的客戶設置直接付款授權並具有第2&#x28;a&#x29;條中規定的含義。 「閣下」及「閣下的」指立橋證券提供證券服務的每位客戶，及如文義允許，包括任何獲客戶授權向立橋證券發出有關使用證券服務的指示或要求的人士。 「結算公司」指香港銀行同業結算有限公司及其繼承人及受讓人。 「結算公司快速支付系統」或「快速支付系統」指由結算公司不時提供、管理及運作的快速支付系統及其相關設施及服務，用作&#x28;i&#x29;處理直接付款及存款、資金轉賬及其他付款交易；及&#x28;ii&#x29;就電子直接付款授權服務及賬戶綁定服務交換及處理指示。 「香港」指中華人民共和國香港特別行政區。 「監管規定」指本公司、銀行、結算公司、任何其他參與者、彼等各自的聯繫公司或集團公司或閣下不時受規限或被期望遵守的任何法律、規例或法庭判令，或由任何監管機構、政府機關&#x28;包括稅務機關&#x29;、結算或交收銀行、交易所、業界或自律監管團體&#x28;不論于香港境內或境外&#x29;發出的任何規則、指示、指引、守則、通知或限制&#x28;不論是否具有法律效力&#x29;。`,
          // text_13: '2. 電子直接付款授權服務',
          // text_14: '(a) 基於立橋證券與銀行的授權與合作，立橋證券將向客戶申請電子直接付款授權服務提供相應服務，即客戶若通過立橋證券向銀行申請電子直接付款授權服務的，立橋證券將協助前述申請指令、資料及資訊按照銀行要求路徑傳送至銀行，授權被銀行批核后，客戶可直接向立橋證券發出指示，進行由銀行至立橋證券的直接付款授權資金轉賬。若該授權申請被銀行拒絕，立橋證券會通知客戶該授權結果，但並不會就該授權結果負任何責',
          // text_15: '銀行賬號只能輸入數字'
        }
      },
      remit: {
      ...
      tips: {
        text_1: '1.什麼是快捷入金？',
        text_2: '快捷入金是指客戶通過eDDA授權立橋證券從指定的香港銀行帳戶劃撥指定數額的資金至證券帳戶。eDDA即電子直接付款授權，是香港金管局推出的FPS轉數快系統的增值服務。',
        text_3: '2.快捷入金有哪些優勢',
        text_4: '極速到賬、免手續費。通過智珠宝直接入金，無需登入銀行端。'
      }
    },
    fps: {
      text_1: '立橋證券FPS收款賬戶資料：',
      text_2: 'FPS識別碼',
      text_3: '收款銀行',
      text_4: '收款戶名',
      text_5: '查看FPS轉數快指南',
      tips: {
        ...
        text_11: '(3)收款人信息欄輸入立桥FPS識別碼：4917753',
        text_12: '(4)確認收款人戶名是否為：Well Link Securities',
        text_13: '(5)轉賬成功後截圖作為匯款憑證',
        text_14: '(6)上傳匯款憑證（可直接點擊），或打開智珠宝App，點擊【我的】-【證券服務】-【存入資金】，進行上傳'
      }
    },
    eBanking: {
      text_1: '立橋證券網銀轉賬收款賬戶資料：',
      text_2: '收款賬號',
      text_3: '銀行中文名',
      text_17: '銀行英文名',
      text_4: '賬號名稱',
      ...
      text_12: '收款賬號由立橋證券在星展銀行以您的名義開立,用於接收來自大陸銀行的同名,點擊免費免費獲取收款賬號.請註意,賬號需要至少60分鐘才能生效,壹經生效,可永久使用',
    ...
    check: {
      ...
      text_4: '收款人賬號',
      text_5: '2、發起匯款通知：',
      text_6: '在APP發起匯款通知上傳支票的圖片，通知立桥確認支票是否無誤',
      text_7: '3、郵寄支票',
      text_8: '收到立桥短信回復支票無誤再將支票郵寄到以下',
  ...
  withdraw: {
    ...
    select_bank: {
      text_1: '出金提示',
      text_2: '近期有較多客戶反饋大陸銀行無法接收外匯匯款。如發生退款，已收取的手續費銀行不做退回，並且退款時間較長（5-20個工作日）。立桥正在準備新的出金渠道盡力為客戶提供順暢的服務體驗。如您近期有提款需求，建議提前辦理香港銀行卡。',
      text_3: '辦卡指引',
    ...
    request: {
      ...
      text_19: '可提金額：',
      text_20: '全部提取',
      text_21: '200-400港幣（銀行收取), 提取金額1000元以下時立橋證券將收取10港幣手續費',
      text_22: '5-10個銀行工作日',
      text_23: '5-10個銀行工作日',
      text_24: '提取',
      text_25: '請選擇您的提取賬戶',
  ...
  my_bank: {
    ...
    text_7: '解綁失敗',
    text_8: '您還沒有綁定銀行卡',
    text_9: '1.【我的銀行卡】中記錄了您入金銀行卡相關信息，立橋證券保證所有信息只會用於您在立橋證券的出入金等資金操作，不會用於其他任何行為；',
    text_10: '2.很抱歉當前不支持香港銀行卡刪除操作，如果有刪除需求請您咨詢客服',
    text_11: '立橋證券每個用戶最多可使用三張香港銀行卡入金，您需要解綁至少壹張香港銀行卡，才能選擇其他銀行卡入金',
    text_12: '立橋證券每個用戶最多可使用三張大陸銀行卡入金，您需要解綁至少壹張大陸銀行卡，才能選擇其他銀行卡入金',
  ...
  out_stock: {
    name: '轉出股票',
    info_tips: '請您至立橋證券官網下載並填寫轉出股票表格，若有疑問，請諮詢客服400-688-3187'
  },
  brokerage: {
    name: '我的佣金'
  },
