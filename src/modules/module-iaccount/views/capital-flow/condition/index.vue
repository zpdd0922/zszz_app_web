            ...
            <p class="items">
              <span
                ...
                :class="{'active':
                  ...
                  item.type === 'currencyType' && (currencyTypeSel ? (items.key === currencyTypeSel.key) : items.default) ||
...
const conditionArr = [
  ...
  },
  {
    ...
    type: 'currencyType',
    option: [
      { text: 'text_34', key: 'all', default: true },
      { text: 'text_18', key: '2' },
      { text: 'text_19', key: '1' }
    ]
  },
  ...
  methods: {
    ...
    reSet(flag) {
      ...
      if (this.isFilterCriteria || flag === 'all') {
        ...
        this.$store.commit('CURRENCY_TYPE', this.currencyTypeSel)
