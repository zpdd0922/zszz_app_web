    ...
    <div class="olhk-step olhk-step-info-other">
      <cube-form :model="model" class="step-content">
        ...
        <!-- <template v-if="disclosureDefine.isAccountOwner.isCanFalse && !model.isAccountOwner">
            ...
            <cube-form-item :field="fieldsAccountOwner[4]">
              <cube-textarea
                v-model="model.otherOwnerAddress"
                :placeholder="fieldsAccountOwner[4].props.placeholder"
                :maxlength="50"
                :indicator="false"
              ></cube-textarea>
            </cube-form-item>
        ...
        <cube-form-group class="custom-form-group">
          ...
          <template v-if="disclosureDefine.isAccountManager.isCanFalse && !model.isAccountManager">
            ...
            <cube-form-item :field="fieldsAccountManager[4]">
              <cube-textarea
                v-model="model.otherManagerAddress"
                :placeholder="fieldsAccountManager[4].props.placeholder"
                :maxlength="50"
                :indicator="false"
              ></cube-textarea>
            </cube-form-item>
