...
export default {
    ...
    isAllowProvidePrivacy: {
        title: "個人資料用於直接促銷聲明",
        tips: "查看更多 >",
        tipsContent: "本人謹此承認並確定已獲得按照本人所選語言（中文或英文）的個人資料（私隱）條例有關收集及使用個人資料用於直接促銷的通知並獲得其解釋，以及本人已獲邀請細閱該通知，提出問題及如有意願，徵求獨立意見。本人確認已經保留該通知副本一份，以作備考之用。本人：",
    ...
    tax: {
        ...
        privacyNum: {
            ...
            canOffer: '能提供編號',
            cannotOffer: '不能提供編號',
            reasonA: '理由A：賬戶持有人的居留司法管轄區並沒有向其居民發出稅務編號。',
            reasonB: '理由 B：賬戶持有人不能取得稅務編號。如選取這壹理由，解釋賬戶持有人不能取得稅務編號的原因。',
            reasonBPlaceholder: '請輸入理由，200字以內',
            reasonC: '理由 C : 賬戶持有人毋須提供稅務編號。居留司法管轄區的主管機關不需要賬戶持有人披露稅務編號。',
        }
    },
}