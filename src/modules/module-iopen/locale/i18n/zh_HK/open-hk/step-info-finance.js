...
export default {
    ...
    finance: {
        ...
        totalAssets: {
            label: '總淨資產', placeholder: '請選擇總淨資產', options: {
                ltOneMillion: '<100萬港幣',
        ...
        investTarget: {
            label: '投資目的', placeholder: '請選擇投資目的', options: {
                shortTerm: '短線',
                longTerm: '中長線',
                speculation: '投機',
                hedging: '對沖',
        ...
        investTargetOther: { label: '其他投資目的', placeholder: '請填寫其他投資目的' },
        residence: {
            label: '住宿', placeholder: '請選擇住宿', options: {
                rented: '租用物業',
                selfOwned: '自置物業',
                mortgage: '按揭物業',
                companyQuarter: '公司宿舍',
        ...
        residenceOther: { label: '其他住宿', placeholder: '請填寫其他住宿方式' },
    },
    // assets: {
    // title: '財產種類',
