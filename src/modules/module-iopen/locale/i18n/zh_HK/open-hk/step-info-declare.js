...
title: "個人資料用於直接促銷聲明",
tips: "查看更多 >",
tipsContent: "本人謹此承認並確定已獲得按照本人所選語言（中文或英文）的個人資料（隱私）條例有關收集及使用個人資料用於直接促銷的通知並獲得其解釋，以及本人已獲邀請細閱該通知，提出問題及如有意願，徵求獨立意見。本人確認已經保留該通知副本一份，以作備考之用。本人：",
...
title: "北向交易聲明",
tips: "查看更多 >",
tipsContent: `本人確認本人已閱讀並瞭解個人資料收集用於中華通北向交易的內容。通過勾選以下的方框及簽署，本人：`,
...
add: "添加新的稅務信息",
remove: "刪除上個稅務信息",
tips: '警告：根據《稅務條例》第80(2E)條，如任何人在作出自我證明時，在明知壹項陳述在要項上屬具誤導性、虛假或不正確，或罔顧壹項陳述是否在要項上屬具誤導性、虛假或不正確下，作出該項陳述，即屬犯罪。壹經定罪，可處第3級（即港幣$10,000）罰款。有關定罪及處罰按不時修訂的法例為准。',
min:'最少填報1個稅務信息',
max:'最多填報5個稅務信息',
countryKey: {
label: '司法管轄區',
